...
import { Building2, Mail, Lock, AlertCircle, Eye, EyeOff, ArrowRight, Shield, CheckCircle } from 'lucide-react'
      ...
      <div style={styles.card}>
        <div style={styles.logoContainer}>
          <div style={styles.logoIcon}>
            <Building2 size={isMobile ? 32 : 40} color="white" />
          </div>
          <h1 style={styles.title}>MeuPiloto!</h1>
          <p style={styles.subtitle}>Acesso para Associações</p>
        </div>
        ...
        <div style={styles.footer}>
          <p>
            Plataforma de Gestão de Transporte
          </p>
